...
|---|---|---|
| 1 | SunFounder ESP32 camera extension board/controller | Exact revision/pinout and USB location unknown; mounting centres 60 × 55 mm user measured |
| 1 | Character LCD and I2C backpack | Historical QAPASS/PCF8574; cutout 70 × 25 mm, hole centres 73 × 30 mm user measured |
...
| 3 | Normally open momentary buttons | Proposed WATER/LAMP TEST/STOP; 12 mm panel holes are placeholders |
...
| 7 | Printed parts | See `STL_CHECKS.json`; nominal mm, concept/test-fit only |
| TBD | Insulating spacers, screws/inserts, ties, glands and strain relief | Match actual board holes and 3.2 mm provisional pilots; check LCD corner clearance |
