...
ax.text(6,168,'R13 · Cable route section at y = 92 mm',fontsize=16,weight='bold')
...
ax.set(xlim=(22,68),ylim=(0,30),xlabel='y / mm',ylabel='z / mm',title='R13 battery saddle: actual STL section at x48 mm')
...
ax.axhline(60,color='#8d9860',ls='--',label='Sump rim z60 (reference)')
ax.annotate('8 mm sensor entry\ncentre y65 / z64\nLowest edge at sump rim',xy=(65,64),xytext=(10,110),arrowprops=dict(arrowstyle='->'),fontsize=10)
ax.set(xlim=(-5,105),ylim=(40,130),xlabel='y / mm',ylabel='z / mm',title='R13 moisture sensor entry: actual STL section at x93')
