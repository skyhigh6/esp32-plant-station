...
report={'units':'mm','revision':'R13','files':{},'sections':{}}
meshes={}
...
report['sections']['sensor_entry']=bore_section(meshes['tower_sump_body'],[93,0,0],[1,0,0],[[65,64]],[1,2],[8])
...
print('PASS: 19 exported meshes; rotated mount pattern, USB opening, piezo/LED seats and knob sections',flush=True)
