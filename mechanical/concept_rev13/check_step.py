...
report={'revision':'R13','units':'mm','files':{}}
...
assert assy.isValid() and len(assy.Solids())==4
report['assembly_solids']=4
report['result']='PASS'
(OUT/'step_check.json').write_text(json.dumps(report,indent=2))
print('PASS: reopened 19 STEP single solids and four-part assembly; STL bounds/volumes agree',flush=True)
