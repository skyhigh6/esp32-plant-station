"""Plant Station R8. Millimetres; x right, y rear, z up. Run with local cad-runtime."""
...
def verify():
    report={'revision':'R8','units':'mm','cadquery':cq.__version__,'parts':{},'pairwise':[],'critical':{}}
