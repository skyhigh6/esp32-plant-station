...
report={'units':'mm','revision':'R8','files':{},'sections':{}}
meshes={}
...
report['sections']['USB_access']=rectangular_opening(meshes['tower_sage'],[3,0,0],[1,0,0],[1,2],[[49,98.5],[77,118.5]])
...
print('PASS: 22 exported meshes; rotated mount pattern, USB opening, piezo/LED seats and knob sections',flush=True)
