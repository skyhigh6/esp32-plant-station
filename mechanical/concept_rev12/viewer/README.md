# R12 interactive STL explorer

From the repository root, run `python -m http.server 8769 --bind 127.0.0.1 --directory mechanical/concept_rev12`, then open http://127.0.0.1:8769/viewer/ . Stop the server with Ctrl+C.
