"""Plant Station R12. Millimetres; x right, y rear, z up. Run with local cad-runtime."""
...
# R12: one structural base; retain both water-containing walls below the rim.
...
riser=rounded(94,84,4,38,16,124,1)
...
# Moisture sensor enters directly above planter, separate from wet tube path.
combined=cut(combined,cyl(89,65,128,4,9,(1,0,0)))
...
# Preserve existing holder fixing holes as optional access bores.
for x in (18,78):
    combined=cut(combined,cyl(x,45,8,1.7,5))
...
def verify():
    report={'revision':'R12','units':'mm','cadquery':cq.__version__,'parts':{},'pairwise':[],'critical':{}}
    ...
    report['cable_checks']={'bridge_continuity_probe':'PASS','tube_and_two_wire_and_sensor_probes':'PASS','full_height_sump_wall_probe':'PASS','rim_to_crossover_bottom_mm':17,'routing':'supported common service area; separated tube and pump-wire bores; independent above-planter sensor entry'}
