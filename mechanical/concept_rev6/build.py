"""Plant Station R6. Millimetres; x right, y rear, z up. Run with local cad-runtime."""
...
def verify():
    report={'revision':'R6','units':'mm','cadquery':cq.__version__,'parts':{},'pairwise':[],'critical':{}}
