# R9 interactive STL explorer

From the repository root, run `python -m http.server 8766 --bind 127.0.0.1 --directory mechanical/concept_rev9`, then open http://127.0.0.1:8766/viewer/ . Stop the server with Ctrl+C.
